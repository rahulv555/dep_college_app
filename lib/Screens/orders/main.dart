...
class _OrdersHomeState extends State<OrdersHome> {
  Map cardcolor = {0: Colors.grey, 2: Colors.green};
            ...
            return Column(
              children: [
                Card(
                  ...
                  color: widget.orders[index].status != 2 ? Theme.of(context).scaffoldBackgroundColor : cardcolor[widget.orders[index].status],
                  child: Container(
                          ...
                          child: Column(
                            children: [
                              Row(
                                ...
                                children: [Text(_outlet_names[int.parse(widget.outlets[index])], style: TextStyle(color: Theme.of(context).primaryColor))],
                              ),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                              ...
                                              FirebaseFirestore.instance
                                                  ...
                                                  .then((value) {
                                                    if (value.size > 0) {
                                                      ...
                                                      // Update the parameter value
                                                      documentSnapshot.reference.update({'status': 3});
                                                    }
                                                  });
                                            })
                                            .catchError((error) {
                ...
                if (widget.orders[index].status == 1) Text('Getting ready...', style: TextStyle(color: Colors.red)),
