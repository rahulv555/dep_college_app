                        ...
                        children: [
                          Card(
                              ...
                              child: Column(children: [
                                Container(  
                                    padding: EdgeInsets.all(10), child: Text('ORDER ID : ' + widget.orders[index].orderid.substring(23), style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20))),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Text('Name : ' + widget.orders[index].custname,
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                        )),
                                    Text('Phone Number : ' + widget.orders[index].phonenumber,
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                        )),
                                  ],
