...
class _FoodHomePageState extends State<FoodHomePage> {
  final List<String> _image_locs = [
    'assets/images/main-cafe.jpg',
    'assets/images/maggipoint.jpg',
    'assets/images/juice-corner.jpg',
    'assets/images/keralacanteen.jpg',
    'assets/images/coffeeday.jpg',
  ];
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image(
                          fit: BoxFit.contain,
                          width: 400,
                          image: new AssetImage(_image_locs[index])),
                    ),
                    Container(
