...
class EditCoupon extends StatefulWidget {
  ...
  EditCoupon(this._editCoupon, this.index, this.coupon) {
    ...
    //date
    if (DateFormat("YYYYMMDD").format(DateTime.now()) ==
        DateFormat("YYYYMMDD").format(coupon.dov)) {
      selectedDate = date[0];
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButton(
                      ...
                      items: widget.vendors.keys.map((String items) {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButton(
                      ...
                      items: widget.meal.keys.map((String items) {
                        return DropdownMenuItem(
                          value: items,
                          child: Padding(
                            padding: const EdgeInsets.all(8.0),
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButton(
                      iconEnabledColor: Theme.of(context).primaryColor,
                      items: widget.date.map((String items) {
                        return DropdownMenuItem(
                          value: items,
                          child: Padding(
                            padding: const EdgeInsets.all(8.0),
